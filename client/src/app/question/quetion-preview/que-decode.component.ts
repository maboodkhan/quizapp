...
@Component({
  selector: 'app-que-decode',
  template: `
   ( {{quesLevel}} ) &nbsp;&nbsp; ( <b>Lesson</b> - {{lesson_name}} &nbsp;>> &nbsp; {{topic_name}} )
  <!-- <p [innerHTML]="quesVal"> </p> -->
  <div [appMath]="mathMl"></div>
  <p *ngFor="let ansoption of question.ansoptions">  
    <app-ques-ans [answerOption]="ansoption"></app-ques-ans>
  </p>
    `,
  styles: []
})
export class QueDecodeComponent implements OnInit {
  ...
  ngOnInit() {
    this.quesVal = this.question.question;
