...
@Component({
  selector: 'app-post-topic-chart',
  templateUrl: './post-topic-chart.component.html',
  styleUrls: ['./post-topic-chart.component.css']
})
export class PostTopicChartComponent implements OnInit {
  ...
  getTopicQuizReport() {
    this.postDashboardService.getTopicReport(this.customFilters).subscribe((topicRes: any) => {
