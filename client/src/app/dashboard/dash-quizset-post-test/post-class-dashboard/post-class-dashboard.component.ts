...
@Component({
  selector: 'app-post-class-dashboard',
  templateUrl: './post-class-dashboard.component.html',
  styleUrls: ['./post-class-dashboard.component.css']
})
export class PostClassDashboardComponent implements OnInit {
