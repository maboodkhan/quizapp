...
@Component({
  selector: 'app-post-user-quiz-dash',
  templateUrl: './post-user-quiz-dash.component.html',
  styleUrls: ['./post-user-quiz-dash.component.css']
})
export class PostUserQuizDashComponent implements OnInit {
