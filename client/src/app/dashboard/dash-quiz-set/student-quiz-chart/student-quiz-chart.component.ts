...
@Component({
  selector: 'app-student-quiz-chart',
  templateUrl: './student-quiz-chart.component.html',
  styleUrls: ['./student-quiz-chart.component.css']
})
export class StudentQuizChartComponent implements OnInit {
